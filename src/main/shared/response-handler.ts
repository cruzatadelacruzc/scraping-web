...
export class ResponseHandler {
   ...
   */
  static unAuthenticated(res: Response, isBasicAuth: boolean = false, message: string = 'unauthenticated', error?: any) {
    isBasicAuth && res.set('WWW-Authenticate', 'Basic realm="401"');
