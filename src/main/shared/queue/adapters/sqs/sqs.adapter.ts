...
export class SQSQueueAdapter implements IQueueAdapter {
  ...
  public async enqueue<TData>(
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    _queueName: string,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    _data: TData,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    _opts?: IQueueEnqueueOptions,
  ): Promise<string> {
    throw new NotImplementedError('enqueue');
  }

  public registerWorker<TData, TResult>(
    queueName: string,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    _handler: JobHandler<TData, TResult>,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    _opts?: IWorkerOptions,
  ): void {
    this.registeredQueues.add(queueName);
  }

  public onCompleted<TResult = unknown>(
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    _queueName: string,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    _listener: CompletedListener<TResult>,
  ): void {
